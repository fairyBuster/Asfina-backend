...
class SupportChatMessageCreateSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        thread, _ = SupportChatThread.objects.get_or_create(user=user, is_closed=False)
...
class SupportChatAdminReplySerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        thread, _ = SupportChatThread.objects.get_or_create(user=target_user, is_closed=False)
        msg = SupportChatMessage.objects.create(
            thread=thread,
            sender_type='ADMIN',
            sender_user=admin,
